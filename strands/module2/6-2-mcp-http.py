...
if __name__ == "__main__":
    ...
    local_mcp_client = MCPClient(lambda: streamablehttp_client("http://127.0.0.1:8000/mcp/"))
    # Descubrir las tools que expone tu server MCP
    # local_mcp_tools = local_mcp_client.list_tools_sync()
    ...
    agente = Agent(
        ...
        """,
        tools = [buscar_solucion, aws_docs_client, local_mcp_client],
        model = bedrock_Model,
